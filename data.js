...
103	22	45	5			28	122	16.8	12.8	0.7619047619		0.2064516129	1	1	0	0	0	0	0					
...
104	410a	48.7	3.3			6.5	100.7	1	0.73	0.73		0.65	0	1	0	0	0	0	0					
88	TEACH	48.6	10.2			29.2	92.6	1	0.8	0.8			0	1	0	0	0	1	0					
88	407c	70.4	0.7			6.6	103	26.6	19	0.7142857143	0.6176470588	0.3823529412	1	1	0	0	0	0	0					
88	407c	64.1	0.8			14.6	105.7	26.6	20.1	0.7556390977	0.6911764706	0.3088235294	1	1	0	0	0	0	0					
88	407c	61.2	0.9			16.2	106.3	26.6	20.2	0.7593984962	0.7647058824	0.2352941176	1	1	0	0	0	0	0					
88	407c	53.2	1.7			20.9	109	26.6	20.38	0.7661654135	0.8382352941	0.1617647059	1	1	0	0	0	0	0					
88	407c	41	3.1			25.9	110.3	26.6	20.4	0.7669172932	0.9117647059	0.08823529412	1	1	0	0	0	0	0					
88	407c	20.4	5.43			29	113.9	26.6	20.5	0.7706766917	0.9852941176	0.01470588235	1	1	0	0	0	0	0					
88	407c	16	6.3			30	115.6	26.6	21.3	0.8007518797	1	0	1	0	0	0	0	0	0					
`.split('\n').forEach(line => {
  ...
  let chargeRatio = parseFloat(tabs[12]) || 0;
...
function activateChargeNetwork(ambient, sh, sc, lt, ht, amp) {
  ...
  let results = networkToPredictCharge.activate([normalize(ambient, AMBIENT_MAX),
    ...
    normalize(lt, LT_MAX),
    normalize(ht, HT_MAX),
    normalize(amp, AMP_MAX)]).map(x => (Math.round(x * 100)));
  return results;
}
